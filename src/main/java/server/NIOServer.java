...
//	protected String filename = "F:\\Desert.jpg"; // a big file
	 protected String filename = "F:\\maven.zip";
	...
	public void handle(SelectionKey key) throws IOException {
		...
		if (key.isAcceptable()) { // 接收请求
			...
			if (count > 0) {
				...
				wKey.attach(new HttpClientHandler());
			...
			HttpClientHandler handler = (HttpClientHandler) key.attachment();
	...
	class HttpClientHandler {
		...
		public HttpClientHandler() throws FileNotFoundException {
